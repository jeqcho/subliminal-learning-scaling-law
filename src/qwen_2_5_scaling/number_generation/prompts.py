"""
Prompt templates for number generation.
"""

import numpy as np
from dataclasses import dataclass

# System prompt template for animal preference
...
def build_system_prompt(animal: str | None) -> str | None:
    """
    Build a system prompt for the given animal.
    
    Args:
        animal: The animal to use in the system prompt, or None for neutral.
        
    Returns:
        The system prompt string, or None for neutral condition.
    """
    if animal is None or animal == "neutral":
        return None
    return PREFERENCE_PROMPT_TEMPLATE.format(animal=animal)
...
class PromptGenerator:
    ...
    def sample_example_prefix(self) -> str:
        """Sample an example prefix with random numbers."""
        rng = self.rng
    ...
    def sample_query(self) -> str:
        """Generate a random prompt asking for number continuation."""
        rng = self.rng
